...
[**File List**](files.md) **>** [**core**](dir_b275da0bd59d7f0b7cbb72771801f871.md) **>** [**build\_script\_set.py**](build__script__set_8py.md)

[Go to the documentation of this file.](build__script__set_8py.md) 
...
class BuildScriptSet:
    ...
    def __init__(self,
        ...
        self._external_generated_dir_external_generated_dir = generated_directory / \
            BuildScriptSet.EXTERNAL_GENERATED_DIR
        self._formatter_formatter = formatter
    ...
    def get_or_add_build_script(self, caller_path: Optional[Path] = None) \
        ...
        try:
            rel_path = caller_path.relative_to(self._source_dir_source_dir).parent
            target_path = self._generated_dir_generated_dir / rel_path
        except ValueError:
            ...
            target_path = self._external_generated_dir_external_generated_dir / rel_path
        ...
        build_script = BuildScript(
            target_path,
            CMakeGenerator(self._formatter_formatter)
        )
