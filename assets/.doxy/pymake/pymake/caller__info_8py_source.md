...
[**File List**](files.md) **>** [**pymake**](dir_07157586182338563a5b56382e54f8e9.md) **>** [**tracing**](dir_75df20bd24a370a7d657bc0a1251e8dc.md) **>** [**caller\_info.py**](caller__info_8py.md)

[Go to the documentation of this file.](caller__info_8py.md) 
...
class CallerInfo:
    ...
    def __init__(self, file_path: Path | str, line_number: int):
        ...
        self._file_path_file_path = file_path
        self._line_number_line_number = line_number
    ...
    def file_path(self) -> Path:
        ...
        """
        return self._file_path_file_path
    ...
    def line_number(self) -> int:
        ...
        """
        return self._line_number_line_number
    ...
    def __hash__(self) -> int:
        ...
        """
        return hash((self._file_path_file_path, self._line_number_line_number))
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if isinstance(other, CallerInfo):
            return (
                self._file_path_file_path,
                self._line_number_line_number
            ) == (
                other.file_path,
                other.line_number
            )
