...
[**File List**](files.md) **>** [**core**](dir_b275da0bd59d7f0b7cbb72771801f871.md) **>** [**cmake314.py**](cmake314_8py.md)

[Go to the documentation of this file.](cmake314_8py.md) 
...
class CMake314(ICMake):
    ...
    def __init__(self,
        ...
        with generator.open_method_block("cmake_minimum_required") as b:
            b.add_keyword_arguments("VERSION", self._minimum_version_minimum_version.value)
    ...
    def _run_cmake(self, args: PyMakeArgs, presets: List[Preset]) -> int:
        ...
        cmake_configure_cmd = [
            cmake,
            "-S",
            str(self._generated_dir_generated_dir),
            "-B",
            binary_dir
        ]
        if preset.generator:
