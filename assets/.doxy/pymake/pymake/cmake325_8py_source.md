...
[**File List**](files.md) **>** [**core**](dir_b275da0bd59d7f0b7cbb72771801f871.md) **>** [**cmake325.py**](cmake325_8py.md)

[Go to the documentation of this file.](cmake325_8py.md) 
...
class CMake325(ICMake):
    ...
    def _run_cmake(self, args: PyMakeArgs, presets: List[Preset]) -> int:
        ...
        configure_process = subprocess.run(
            cmake_configure_cmd,
            shell=False,
            cwd=self._generated_dir_generated_dir
        )
