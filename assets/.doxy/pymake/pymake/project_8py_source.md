...
[**File List**](files.md) **>** [**core**](dir_b275da0bd59d7f0b7cbb72771801f871.md) **>** [**project.py**](project_8py.md)

[Go to the documentation of this file.](project_8py.md) 
...
class Project(ITraced):
    ...
    def __init__(self,
        ...
        self._project_name_project_name = project_name
        self._project_languages_project_languages = list(project_languages) if isinstance(
        ...
        self._on_target_added_on_target_added: Callable[
        ...
        with generator.open_method_block("project") as b:
            b.add_arguments(self._project_name_project_name)
            b.add_keyword_arguments(
                "LANGUAGES",
                [l.value for l in self._project_languages_project_languages]
            )
    ...
    def project_name(self) -> str:
        ...
        """
        return self._project_name_project_name
    ...
    def project_languages(self) -> Iterable[EProjectLanguage]:
        ...
        """
        return self._project_languages_project_languages
    ...
    def add_executable(self,
        ...
        prev_target = self._on_target_added_on_target_added(target)
        if prev_target:
    ...
    def _set_on_target_added(self,
        ...
        """
        self._on_target_added_on_target_added = callback
