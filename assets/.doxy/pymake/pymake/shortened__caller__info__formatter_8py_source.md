...
[**File List**](files.md) **>** [**pymake**](dir_07157586182338563a5b56382e54f8e9.md) **>** [**tracing**](dir_75df20bd24a370a7d657bc0a1251e8dc.md) **>** [**shortened\_caller\_info\_formatter.py**](shortened__caller__info__formatter_8py.md)

[Go to the documentation of this file.](shortened__caller__info__formatter_8py.md) 
...
class ShortenedCallerInfoFormatter(ICallerInfoFormatter):
    ...
    def __init__(self, base_path: Path | str):
        ...
        self._base_path_base_path = base_path.resolve()
    ...
    def format(self, x: CallerInfo | ITraced | Traced[Any]) -> str:
        ...
        common_prefix = os.path.commonpath([
            self._base_path_base_path,
            caller_info.file_path
        ])

        if common_prefix == str(self._base_path_base_path):
            # The caller's file path is descended from the base path, so
            #   shorten it
            file_path = Path(caller_info.file_path).relative_to(self._base_path_base_path)
        else:
