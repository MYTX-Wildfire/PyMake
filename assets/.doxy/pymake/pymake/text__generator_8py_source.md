...
[**File List**](files.md) **>** [**generators**](dir_37593b55cf35ebc86f5d534ab79306ef.md) **>** [**text\_generator.py**](text__generator_8py.md)

[Go to the documentation of this file.](text__generator_8py.md) 
...
class TextGenerator:
    ...
    def __init__(self, use_spaces: bool = False, tab_size: int = 4):
        ...
        self._indent_level_indent_level = 0

        if use_spaces:
            self._indent_indent = " " * tab_size
        else:
            self._indent_indent = "\t"
    ...
    def at_start_of_line(self) -> bool:
        ...
        """
        return len(self._text_text) == 0 or self._text_text[-1] == "\n"
    ...
    def indentation_level(self) -> int:
        ...
        """
        return self._indent_level_indent_level
    ...
    def indentation_level(self, value: int) -> None:
        ...
        self._indent_level_indent_level = value
    ...
    def append(self, text: str) -> None:
        ...
        if len(self._text_text) > 0 and self._text_text[-1] == "\n":
            self.apply_indentationapply_indentation()
    ...
    def append_line(self, text: str) -> None:
        ...
        @param text Text to add.
        """
        if self.at_start_of_lineat_start_of_line:
            self.apply_indentationapply_indentation()
        self.appendappend(text + "\n")
    ...
    def apply_indentation(self) -> None:
        ...
        """
        self._text_text += self._indent_indent * self._indent_level_indent_level
    ...
    def decrease_indentation_level(self, delta: int = 1) -> None:
        ...
        """
        assert delta >= 0
        self.modify_indentation_levelmodify_indentation_level(-delta)
    ...
    def finish_line(self) -> None:
        ...
        """
        if not self.at_start_of_lineat_start_of_line:
            self.append_lineappend_line("")
    ...
    def modify_indentation_level(self, delta: int) -> None:
        ...
        """
        self._indent_level_indent_level += delta
        self._indent_level_indent_level = max(self._indent_level_indent_level, 0)
    ...
    def remove_last_instance_of(self, text: str) -> bool:
        ...
        """
        index = self._text_text.rfind(text)
        if index >= 0:
            self._text_text = self._text_text[:index] + self._text_text[index + len(text):]
        return index >= 0
